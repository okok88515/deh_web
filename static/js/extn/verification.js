                ...
                if (content == "poi") {
                    ...
                    if (counts != 0) {
                        ...
                        for (var i = 0; i < counts; i++) {
                            ...
                            <button class="btn btn-danger" style="float:right" onclick="Verify(\'' + content + '\',' + data.all_poi[i].poi_id + ',-1)">驗證不通過</button></th></table>'
                            );
                        }
                    } else {
                    ...
                    if (counts != 0) {
                        ...
                        for (var i = 0; i < counts; i++) {
                            ...
                            <button class="btn btn-danger" style="float:right" onclick="Verify(\'' + content + '\',' + data.all_loi[i].route_id + ',-1)">驗證不通過</button></th></table>'
                            );
                        }
                    } else {
                        $('.content_detail').append('<h5>共:' + counts + '筆' + role + '景線</h5>');
                    ...
                    if (counts != 0) {
                        ...
                        for (var i = 0; i < counts; i++) {
                            ...
                            <button class="btn btn-danger" style="float:right" onclick="Verify(\'' + content + '\',' + data.all_aoi[i].aoi_id + ',-1)">驗證不通過</button></th></table>'
                            );
                        }
                    } else {
                        $('.content_detail').append('<h5>共:' + counts + '筆' + role + '景區</h5>');
                    ...
                    if (counts != 0) {
                        ...
                        for (var i = 0; i < counts; i++) {
                            ...
                            <button class="btn btn-danger" style="float:right" onclick="Verify(\'' + content + '\',' + data.all_soi[i].soi_id + ',-1)">驗證不通過</button></th></table>'
                            );
                        }
                    } else {
                        $('.content_detail').append('<h5>共:' + counts + '筆' + role + '主題故事</h5>');
